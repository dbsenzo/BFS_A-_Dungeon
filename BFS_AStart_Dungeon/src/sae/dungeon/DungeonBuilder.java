...
public class DungeonBuilder {
	...
	public Dungeon createMyFirstDungeon() {	
		String data = Util.usingBufferedReader("Donjon_Added_1.txt");
		return (new GeneratorDungeonFrom(data)).getDungeon();
	}
	
	public Dungeon createMySecondDungeon() {	
		String data = Util.usingBufferedReader("Donjon_Added_2.txt");
		return (new GeneratorDungeonFrom(data)).getDungeon();
	}
